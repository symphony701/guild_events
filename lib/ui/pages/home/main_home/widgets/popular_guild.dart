...
import 'package:guild_events/ui/pages/guild_view/guild_view_page.dart';
...
class PopularGuildCard extends StatelessWidget {
  ...
  const PopularGuildCard(this.idGuild, {Key? key}) : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => GuildViewPage(idGuild),
          ),
        );
      },
      child: Container(
